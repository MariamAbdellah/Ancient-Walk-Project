...
{/* <div className="d-flex ps-5 ms-5 mobpm">
  <img src="/img/hool.png" alt="image" className="frame"></img>
</div> */}
 ...
 <div className="glass-container col-12 col-md-9 col-lg-4 mt-5 mob mobpm">
    ...
    <form>
        ...
        <div className="d-flex form-label pt-3">
          <ul >
            <li class="list-group-item "><i class="bi bi-check-lg"></i>You must provide accurate information.</li>
            <li class="list-group-item"><i class="bi bi-check-lg"></i>You are responsible for keeping your password secure.</li>
            <li class="list-group-item"><i class="bi bi-check-lg"></i>You must not share your account with others.</li>
          </ul>
        </div>
        <div className="form-check d-flex align-items-center">
